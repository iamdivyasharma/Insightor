...
Original file is located at
    https://colab.research.google.com/drive/1orUoIPzdCNRBWnNynNfs8cBZ8Ek9k8EI
"""
...
#     HUGGINGFACE_TOKEN = HF  # Replace with your token
...
# Main application
def main():
    print("Enhanced RAG Chatbot for Unstructured Data")
    print("Upload PDFs, Excel, or CSV files to get fast and accurate insights.")

    # Upload files
    uploaded_files = ["/content/bh1.pdf"]  # Replace with your file paths

    documents = process_files(uploaded_files)
    if not documents:
        print("No valid documents found. Please upload supported files.")
        return
